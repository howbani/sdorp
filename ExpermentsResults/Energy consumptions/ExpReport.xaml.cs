...
namespace SDORP.ExpermentsResults.Energy_consumptions
{
    class ResultsObject
    {
    ...
    public partial class ExpReport : Window
    {
        ...
        public ExpReport(MainWindow _mianWind)
        {
            ...
            double averageWaitingTime = Convert.ToDouble(PublicParamerters.TotalWaitingTime) / NumberOfGenPackets;
            res.AverageWaitingTime = averageWaitingTime;
            double avergaeRedundan = Convert.ToDouble(PublicParamerters.TotalReduntantTransmission) / NumberOfGenPackets;
...
//            List.Add(new ValParPair() { Par = "D-Control", Val = Settings.Default.ExpoDCnt.ToString() });
            ...
            List.Add(new ValParPair() { Par = "Protocol", Val = "SDORP" });
