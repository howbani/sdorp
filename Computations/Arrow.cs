...
namespace SDORP.Intilization
{
	public sealed class Arrow : Shape
	{
        ...
        private Storyboard IntilaizeStory(Point start, Point end, long colorID)
        {
            ...
            aRectangle.Width = 7;
            aRectangle.Height = 7;
            int cid = Convert.ToInt16(colorID % PublicParamerters.RandomColors.Count);
            aRectangle.Background = new SolidColorBrush(PublicParamerters.RandomColors[cid]);
        ...
        public void  AnimateValues(long PID) 
        {
           ...
           // PacketAnimator.Remove(PublicParamerters.MainWindow.Canvas_SensingFeild);
            ...
            PublicParamerters.MainWindow.Canvas_SensingFeild.Dispatcher.Invoke(() => Stroke = new SolidColorBrush(PublicParamerters.RandomColors[cid]));
