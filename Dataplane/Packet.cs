...
namespace SDORP.Dataplane.NOS
{
    ...
    public class Packet
    {
        ...
        public double DistanceToSink { set; get; } // the distance from source to the sink, or cluster head.


        public double EDC_for_Path { get; set; }

        public Sensor nforwarder { get; set; }
